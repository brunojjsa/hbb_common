...
pub const RENDEZVOUS_SERVERS: &[&str] = &["ec2-15-229-244-18.sa-east-1.compute.amazonaws.com"];
pub const RS_PUB_KEY: &str = "eWaE72YjSwuLnbXa8IgsGhIHsJJLGrlMWdTOQMAe6mM=";
